...
- YOLOv8n-pose RKNN RTSP 실시간 표시 + ByteTrack-style ID 표시
- RTSP low-latency 입력
...
pose demo는 사람 pose bounding box를 ByteTrack-style two-stage IoU matching에 넣고,
매칭된 ID에 skeleton, bbox, trail을 함께 표시합니다.
